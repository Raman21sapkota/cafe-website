...
function HeroSection() {
  ...
  return (
    <section ref={ref} className="relative min-h-[500px] md:min-h-screen overflow-hidden">
      ...
      <div className="relative z-20 h-[500px] md:h-screen flex items-center justify-center px-8 md:px-16 lg:px-20 text-center" style={{ maxWidth: "1400px", margin: "0 auto" }}>
