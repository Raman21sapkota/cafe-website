    ...
    <>
      ...
      <section className="pt-20 md:pt-28 pb-0 bg-bg-primary text-center">
        <div className="mx-auto px-8 md:px-16" style={{ maxWidth: "1400px" }}>
          ...
          >
            <a
              href="https://www.instagram.com/platedpointlonsdale"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#FCAF45] bg-clip-text text-transparent hover:opacity-80 text-sm font-bold tracking-[0.02em] transition-all duration-300"
            >
              ...
              Follow Plated on Instagram
              <svg className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-0.5" fill="none" viewBox="0 0 24 24" stroke="#E1306C" strokeWidth={2}>
